...
var preAuthProduct = require('./service/haaila/pre-auth-product');
...
exports = module.exports = function(app, passport) {
  ...
  //haaila routes
  app.get('/api/productlist', preAuthProduct.productList);
  app.get('/api/category/:category_id/product/:product_id', preAuthProduct.productDetail);
  app.get('/api/productquery', preAuthProduct.productQuery);
  app.get('/api/measurement/:measurement_id', preAuthProduct.productMeasurement);
