    ...
    copy: {
      vendor: {
        files: [
          ...
          {
            expand: true, cwd: 'client/bower_components/angular-ui-router/release/',
            src: ['angular-ui-router.js'], dest: '<%= distdir %>/vendor/'
          },
          {
            expand: true, cwd: 'client/bower_components/angularjs-slider/dist/',
            src: ['rzslider.js'], dest: '<%= distdir %>/vendor/'
          },
          {
      ...
      asset: {
        files: [
          ...
          {
            expand: true, cwd: 'client/bower_components/bootstrap-sass/assets/fonts/bootstrap/',
            src: ['*'], dest: '<%= distdir %>/fonts/bootstrap'
          }          
        ]
      },
      index: {
