angular.module('account.measurements.index', ['ngRoute', 'security.authorization', 'services.utility', 'services.adminResource']);
...
angular.module('account.measurements.index').controller('UsersIndexCtrl', ['$scope', '$route', '$location', '$log', 'utility', 'adminResource', 'users',
