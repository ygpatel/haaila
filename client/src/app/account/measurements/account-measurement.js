angular.module('account.measurements.detail', ['ngRoute', 'security.authorization', 'services.utility', 'services.adminResource', 'directives.serverError', 'ui.bootstrap']);
angular.module('account.measurements.detail').config(['$routeProvider', function($routeProvider){
  $routeProvider
    .when('/admin/users/:id', {
...
angular.module('account.measurements.detail').controller('UsersDetailCtrl', ['$scope', '$route', '$location', 'utility', 'adminResource', 'user',
