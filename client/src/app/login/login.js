...
angular.module('login.index').controller('LoginCtrl', [ '$scope', '$rootScope','$location', '$log', 'security', 'utility', 'SOCIAL',
  function($scope, $rootScope, $location, $log, security, utility, SOCIAL){
    // local variable
    var loginSuccess = function(data){
      if(data.success){
        //account/user created, redirect...
        //var url = data.defaultReturnUrl || '/home';
